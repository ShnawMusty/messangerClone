    ...
    <Transition.Root show={isOpen} as={Fragment}>
      <Dialog as="div" onClose={onClose} className="relative z-50">
        ...
        <div className='fixed inset-0 z-10 overflow-y-auto'>
          <div className='flex items-center justify-center min-h-full text-center p-4 sm:p-0' >
          <Transition.Child
          as={Fragment}
          enter="ease-out duration-300"
          ...
          >
            <Dialog.Panel className="relative rounded-lg overflow-hidden transform transition-all bg-white text-left w-full px-4 py-4 sm:my-8 sm:w-full sm:max-w-lg sm:p-6">
